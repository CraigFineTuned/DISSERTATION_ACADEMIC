...
**Operationally**, AI fails to integrate with real workflows and collaboration patterns. Departmental silos impede cross-functional collaboration (Benbya et al., 2021), yet AI implementations often reinforce rather than bridge these silos. Application support specialists possess troubleshooting methodologies distinct from network engineers' diagnostic approaches, yet enterprise AI tools treat all IT personnel as interchangeable users. The nuanced expertise developed through years of departmental experience remains inaccessible to generic AI assistants, creating a gap between AI capabilities and organizational operational realities.
...
Recent scholarship has significantly expanded understanding of how Ubuntu principles can guide AI development. Mutswiri et al. (2025) identifies nine operationalization themes for Ubuntu in AI contexts: relationality and interconnectedness, communal decision-making, respect and human dignity, social harmony, collective responsibility, restorative justice and reconciliation, consensus building, hospitality and care, and cultural authenticity. These themes provide concrete mechanisms for translating philosophy into computational behaviors that might bridge AI-organizational gaps.

**Structural Alignment: Relationality**  
Ubuntu's emphasis on relationality matches how IT departments actually function. Network specialists don't operate independently—their work depends on infrastructure stability, affects application performance, and requires coordination with service desk personnel. Ubuntu's principle that "I am because we are" mirrors organizational reality that "my success depends on our collective coordination." This relational framing challenges individualistic AI design assumptions, suggesting systems should recognize interdependencies rather than treat agents as autonomous entities (Birhane, 2021).
...
**Objective 1: Identify AI-Organizational Gaps**  
To identify and document the specific gaps between current AI agent capabilities and real IT departmental workflows, hierarchies, and collaboration needs through empirical investigation of stakeholder experiences and operational contexts.

**Objective 2: Investigate Ubuntu Operationalization**  
To investigate how Ubuntu philosophical principles—interconnectedness, collective responsibility, and communal decision-making—can be operationalized into concrete multi-agent AI behaviors and coordination mechanisms that address organizational collaboration gaps.

**Objective 3: Evaluate Stakeholder Experiences**  
To evaluate how IT department stakeholders across strategic, tactical, and operational levels experience and assess Ubuntu-driven AI agents in addressing collaboration gaps within their actual work contexts, examining perceived effectiveness, cultural authenticity, and organizational alignment.
...
**RQ4: Transferability and Design Principles**  
...
The four research questions guide systematic investigation of gap manifestations, Ubuntu's bridging potential, practitioner perceptions, and enabling organizational factors. The case study approach within GrandWest IT department provides rich contextual understanding while enabling transferable insights for similar organizational contexts. Through Design Science Research methodology and Reflexive Thematic Analysis, this research demonstrates how African philosophical frameworks can inform contemporary AI development, offering an alternative to individualistic AI paradigms that fail to serve collective organizational needs.

The dissertation proceeds with comprehensive literature review across three domains, detailed methodology, system design documentation, empirical findings, theoretical interpretation, and synthesis of contributions to both scholarly discourse and practical AI implementation.

---

**CHAPTER 1 COMPLETE** ✅

**Word Count:** ~7,800 words (enhanced from 7,200)  
**Enhancement:** Section 1.5 now has three explicit subsections (1.5.1 Overall Aim, 1.5.2 Specific Research Aims, 1.5.3 Research Contribution Focus)  
...
**Key Changes in Section 1.5:**
- ✅ Added 1.5.1 Overall Aim - Explicit statement of research purpose
- ✅ Added 1.5.2 Specific Research Aims - Four aims aligned with RQs
- ✅ Added 1.5.3 Research Contribution Focus - Clear YES/NOT distinctions
- ✅ More prominent and structured following Richfield standards
- ✅ Maintains bridging-gap research paradigm throughout
